...
# Algorithm Settings
use_classic_algorithm = True                # updates q_table after every step
...
# Create the trainer
trainer = Trainer(training_settings, logging_settings)

# Start the programm
commander = Commander(board_size)
commander.start(board, trainer, console_settings, agent_save_path)